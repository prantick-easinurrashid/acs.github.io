    ...
    <div id="home">
        ...
        <div class="caption" data-aos="zoom-in" data-aos-duration="1000">
            <div class="row text-center">
                    <div class="col-12">
                        <h1>Welcome to <span style="color: #cda45e;">AUST CSE SOCIETY</span></h1>
                        <h2>Everything About CSE Department</h2>
                        <a href="login.php" class="btn btn-lg btn-outline-secondary">Log In</a>
                        <a href="register.php" class="btn btn-lg btn-outline-secondary">Register</a>
                    </div>
            </div>
        </div>
    </div>
